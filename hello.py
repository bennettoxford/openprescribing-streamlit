...
pages = st.navigation([
    ...
    st.Page("apps/measure_aware/app.py",            title="Measure: aWaRe",                     url_path="measure-aware"),
    st.Page("apps/measure_hypnotics/app.py",        title="Measure: Hypnotics & Anxiolytics",   url_path="measure_hypnotics"),
    st.Page("apps/measure_ome/app.py",              title="Measure: Opioids OME",               url_path="measure-ome"),
